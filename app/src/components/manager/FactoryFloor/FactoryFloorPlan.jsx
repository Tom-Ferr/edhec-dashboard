  ...
  return (
    <div className="factory-floor-plan">
      ...
      <div className="factory-toolbar">
        <div className="flex justify-between items-center bg-gradient-to-r from-blue-50 to-blue-100 px-3 py-2 rounded border border-blue-200 mb-4">
          <h3 className="text-base font-semibold text-[var(--blue-main)] unilever-header">
            FACTORY TOOLS
          </h3>
          <button 
            className="bg-white text-[var(--blue-main)] border border-[var(--blue-main)] px-3 py-1 rounded text-sm font-medium unilever-header hover:bg-[var(--blue-main)] hover:text-white transition-colors"
